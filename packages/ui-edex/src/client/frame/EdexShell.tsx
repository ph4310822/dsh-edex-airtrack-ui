...
import type { CommandResult } from '@danielng23/dsh-airtrack-host-system-metrics/types'
...
export function EdexShell({
  ...
  return (
    ...
    >
      ...
      {/* The ORIGINAL UI wrapped in the standard widget chrome: the center
          container carries the 1px card border + the steel-blue title strip
          (.centerTitle); the WidgetSection below stays fully transparent so
          the workspace (its own #313131 surface) shows through untouched. */}
      <section className={css.centerWidget}>
        <div className={css.centerTitle} aria-hidden="true" />
