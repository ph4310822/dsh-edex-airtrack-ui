 ...
 * status, the featured AIR TRACK tactical map (the reference's signature
 * widget, replacing the WORLD VIEW globe), and traffic charts. The
...
import { AirTrackWidget } from './widgets/AirTrackWidget.tsx'
...
const RIGHT_WIDGETS: RightWidgetSlot[] = [
  ...
  // Compact padding so the featured AIR TRACK map fills more of the bar
  // (the reference's tactical map — the WORLD VIEW globe's replacement).
  { id: 'airtrack', title: 'AIR TRACK', compact: true, Component: AirTrackWidget },
